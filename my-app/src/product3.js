...
function Product3() {
 ...
 const addtochart=async()=>{
    ...
    await setProducts([
      ...products,
      {ilosc:ilos,rozmiar:size,price:120,src:require("./NIKE-AIR-JORDAN4-MILITARY-BLACK.webp")}
    ])
 ...
 useEffect(() => {
  for(let i=0;i<data.products.length;i++){
    if(data.products[i].rozmiar==size&&data.products[i].price==120){
...
useEffect(()=>{
  ...
  return (
   <div id="page">
        ...
        <img src={require("./NIKE-AIR-JORDAN4-MILITARY-BLACK.webp") } id="product"/>
        <ul id="sizes">
        ...
        <span id="title">Air Jordan 4 Military Black</span>
